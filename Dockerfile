FROM ubuntu:bionic
RUN apt-get update && apt-get install -y bison flex git pkg-config zip g++ zlib1g-dev unzip python wget default-jdk libfl-dev golang
